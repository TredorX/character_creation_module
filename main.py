...
def attack(char_name: str, char_class: str) -> str:
    """Функция, которая отвечает за показатель атаки героя."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция, которая отвечает за показатель защиты героя."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция, которая отвечает за показатель спец. атаки героя."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция для треировки возможностей героя."""
    if char_class == 'warrior':
    ...
    print('Введи: attack — атака, defence — защита, special — суперсила.')
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        approve_choice: str = input('Согласен - (Y)/нет - (N)').lower()
    return char_class
